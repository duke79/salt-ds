...
export const NestedVertical: StoryFn<typeof SteppedTracker> = () => {
  return (
    <SteppedTracker
      ...
      style={{ width: 400 }}
    >
      <TrackerStep state="completed" collapsible={true}>
      ...
      <TrackerStep depth={1} state="completed" collapsible={true}>
      ...
      <TrackerStep state="inprogress" collapsible={true}>
        <StepLabel>Step 3</StepLabel>
      </TrackerStep>
      <TrackerStep depth={1} state="inprogress" collapsible={true}>
